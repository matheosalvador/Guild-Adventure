...
/**
 * Adaptateur Gson pour gérer la sérialisation/désérialisation polymorphique.
 * Stocke le nom de la classe dans le JSON pour pouvoir reconstruire le bon type.
 */
